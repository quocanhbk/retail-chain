...
import 'package:bkrm/pages/inventoryModule/purchasedSheet/listDetailSearch.dart';
import 'package:page_transition/page_transition.dart';

import 'package:bkrm/pages/Nav2App.dart';

class DetailSearchPurchasedSheetPage extends StatefulWidget {
  @override
  _DetailSearchPurchasedSheetPageState createState() =>
      _DetailSearchPurchasedSheetPageState();
}

class _DetailSearchPurchasedSheetPageState
    extends State<DetailSearchPurchasedSheetPage> {
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                            ...
                            PageTransition(child: ListDetailSearch(
                              searchId: int.tryParse(idController.value.text),
                              searchNameSupplier:
