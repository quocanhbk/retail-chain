...
import 'package:bkrm/pages/inventoryModule/returnPurchasedSheet/listDetailSearch.dart';
import 'package:page_transition/page_transition.dart';

import 'package:bkrm/pages/Nav2App.dart';

class DetailSearchReturnPurchasedSheetPage extends StatefulWidget {
  @override
  _DetailSearchReturnPurchasedSheetPageState createState() =>
      _DetailSearchReturnPurchasedSheetPageState();
}

class _DetailSearchReturnPurchasedSheetPageState
    extends State<DetailSearchReturnPurchasedSheetPage> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        resizeToAvoidBottomInset: true,
          appBar: AppBar(
            title: Text("Tìm đơn trả hàng nhập"),
          ),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3, child: TextField(
                          decoration: InputDecoration(
                            hintText: "Tên nhà cung cấp hoặc số điện thoại"
                          ),
