        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
                ...
                child: Column(
                  children: [
                    Text("Số lượng :" + item.oldQuantity.toString()),
                    Text("Giá bán :" + formatter.format(item.oldPurchasedPrice)),
                  ],
                ))
          ],
        ),
...
setUpCustomerInfo();
  ...
  setUpCustomerInfo(){
    ...
    widget.returnPurchasedSheet!.returnPurchasedSheet.returnerName == null
        ? "Không có"
        : (widget.returnPurchasedSheet!.returnPurchasedSheet.returnerName=="null"?"Không có":widget.returnPurchasedSheet!.returnPurchasedSheet.returnerName);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Thông tin chi tiết đơn trả"),
        ),
