@extends('main')
@section('breadcrumb')
{{ Breadcrumbs::render('category.create', request()->store_id, request()->branch_id) }}
@endsection
...
<div class="container d-flex flex-column align-items-center">
    <form method="post" class="pb-2" novalidate enctype="multipart/form-data" id="change-quant-form">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="number" class="form-control" id="point_ratio" name="point_ratio" value="0" required>
                <div class="invalid-feedback">
                    Vui lòng điền trường này
                </div>
            </div>
