...
<div class="container-fluid p-0" style=" background-color: white">
    <div id="bg" class="">
        <div id="login-row" class="row justify-content-center align-items-center m-0">
            <div id="login-column" class="col-md-8 d-flex justify-content-center">
                <div id="login-box" class="col-md-12 border border-primary rounded shadow-lg">
                    <strong>Privacy Policy</strong> <p>
                        BKRM built the BKRM app as
                        a Free app. This SERVICE is provided by
                        BKRM at no cost and is intended for use as
                        is.
                      </p> <p>
                        ...
                        BKRM unless otherwise defined in this Privacy Policy.
                        ...
                        this page.
                      </p> <p>This policy is effective as of 2021-06-26</p> <p><strong>Contact Us</strong></p> <p>
                        If you have any questions or suggestions about our
                        Privacy Policy, do not hesitate to contact us at bkrmcontact@gmail.com.
                      </p> 
