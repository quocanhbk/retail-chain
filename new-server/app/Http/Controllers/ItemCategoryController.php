...
class ItemCategoryController extends Controller
{
    ...
    public function createBulk(Request $request) {
        ...
        $rules = [
            ...
            'item_categories.*.name' => ['required', 'string', 'max:255', Rule::unique('item_categories')->where('store_id', $store_id)],
    ...
    public function update(Request $request, $item_category_id) {
        ...
        $item_category = ItemCategory::where('store_id', $store_id)->where('id', $data['id'])->first();
